<?php /*
    ...
    Generated by thesitewizard.com's Feedback Form Wizard 2.21.0.
...
$mailto = 'likuncao@gmail.com' ;
$subject = "Client Message" ;
$formurl = "http://www.lklandscapestudio.com/contact.html" ;
$thankyouurl = "http://www.lklandscapestudio.com/thankyou.html" ;
$errorurl = "http://www.lklandscapestudio.com/error.html" ;
$want_tel_field = 0;
$want_addr_field = 0;
...
$my_recaptcha_private_key = '6LfbCv0UAAAAAFGPoQu9W-7A-vuWd-lGf9Sdb2Yg' ;
...
if (strlen( $my_recaptcha_private_key )) {
	...
	$recaptcha_post_params = http_build_query( array(
								'secret' => $my_recaptcha_private_key,
	...
	$recaptcha_context = stream_context_create(
							array ( 'http' => array(
								...
								'content' => $recaptcha_post_params
								)
							)
						);
	$recaptcha_reply = file_get_contents( $recaptcha_url, FALSE, $recaptcha_context );
	$recaptcha_decoded = ($recaptcha_reply !== FALSE) ? json_decode ( $recaptcha_reply, TRUE ) : NULL ;
	if ($recaptcha_reply === FALSE || $recaptcha_decoded == NULL || (trim($recaptcha_decoded['success']) != TRUE)) {
		header( "Location: $errorurl" );
		exit ;
	}
}
...
$headers =
	"From: \"$fullname\" <$fromemail>" . $linesep . "Reply-To: \"$fullname\" <$email>" . $linesep . "X-Mailer: chfeedback.php 2.21.0" .
